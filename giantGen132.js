...
const giantGen132 = {
    ...
    genEvolutionA() {
        ...
        const items = [
            {q:"生物进化的证据包括",c:"化石比较解剖学胚胎学分子生物学",w:["只有化石","只有解剖学","只有分子生物学"],u:"unit12"},
            {q:"化石是指",c:"保存在地层中的古生物遗体或遗迹",w:["现代生物","活化石","标本"],u:"unit12"},
            {q:"越古老的地层中化石生物",c:"越简单越低等",w:["越复杂越高等","与现代相同","没有规律"],u:"unit12"},
            {q:"同源器官是指",c:"起源相同功能不同的器官",w:["起源不同功能相同","完全相同","没有关系"],u:"unit12"},
